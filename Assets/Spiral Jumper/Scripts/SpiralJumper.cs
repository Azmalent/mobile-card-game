...
{
    public class SpiralJumper : DiGro.SingletonMono<SpiralJumper>
    {
        ...
        public MapParams MapParams => m_mapParams;
        ...
        private void Awake()
        {
            ...
            DiGro.Check.CheckComponent<View.Map>(m_mapViewPrefab);
            ...
            DiGro.Check.CheckComponent<Screens.GameScreenBase>(m_gameScreenPrefab);
